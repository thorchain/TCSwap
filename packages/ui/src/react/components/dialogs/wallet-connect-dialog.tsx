...
export const availableChainsByWallet: Record<WalletOption, Chain[] | readonly Chain[]> = {
  ...
  [WalletOption.KEPLR]: [Chain.Cosmos, Chain.Kujira, Chain.Noble, Chain.THORChain, ...EVMChains],
  [WalletOption.LEAP]: [Chain.Cosmos, Chain.Kujira, Chain.Noble, Chain.THORChain, ...EVMChains],
