...
```typescript
// @noErrorValidation
import { getBitcoinCashToolbox } from '@uswap/toolboxes/utxo';
...
import { convertBCHAddress } from "@uswap/toolboxes/utxo";
...
3. **Validate Address Formats**:
   ...
   ```typescript
   import { validateCashAddr } from "@uswap/toolboxes/utxo";
...
```typescript
// @noErrorValidation
import { validateCashAddr, convertBCHAddress } from "@uswap/toolboxes/utxo";
